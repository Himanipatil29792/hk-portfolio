  ...
  return (
    <div className="flex flex-col md:items-start sm:text-center md:text-left">
     <h2 className="text-6xl text-cyan mb-10">About Me</h2>
      ...
      Hi, I’m Himani Patil, a Front-End Developer with 7.6 years of experience crafting responsive, interactive web applications. I'm proficient in React.js, JavaScript, jQuery, HTML5, CSS3, and Bootstrap5, with a strong focus on building user-friendly, visually appealing interfaces.
      <br/> <br/>
